...
class IceCreamStand(Restaurant):
    """Preparents of Restaurant"""

    def __init__(self, restaurant_name, cuisine_type):
        """Initializes attributes of Ice Cream Stand"""
    ...
    def list_flavors(self):
        ...
        flavors = ('cherry', 'rasberry', 'huba-buba', 'orange', 'banana',
                   'soda')
        print(f"We have a {flavors}")

my_iceCreamnay = IceCreamStand('Tusi on Juice', 'circle')

my_iceCreamnay.list_flavors()